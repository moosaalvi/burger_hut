...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM fast_food WHERE product_id = $id";
...
if (isset($_POST['update'])) {
    ...
    $sql_update = "UPDATE fast_food SET p_name = '$pname', p_qty = $pqty, p_price = $pprice, p_detail = '$pdtl', p_img = '$picto' WHERE product_id = $id";
